...
export default function FAQ() {
  return (
    <section className="container pt-42 sm:pt-56 intersect-once intersect:motion-preset-slide-up motion-delay-200 motion-duration-800 motion-ease-in-out" id="faq">
