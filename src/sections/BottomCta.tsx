...
export default function BottomCta() {
  return (
    <section className="bg-muted/30 flex items-center justify-center pb-16 overflow-hidden  intersect-once intersect:motion-preset-slide-up motion-delay-200 motion-duration-800 motion-ease-in-out">
