...
export default function BottomCta() {
  return (
    <section className=" flex items-center justify-center section-spacing overflow-hidden  intersect-once intersect:motion-preset-slide-up motion-delay-200 motion-duration-800 motion-ease-in-out">
      <div className="container">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:px-6 flex items-center justify-center">
