    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background">
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-20">
        <div className="ml-0 sm:ml-[5%] mt-0 sm:mt-[8%] max-w-4xl transform space-y-8 sm:space-y-12">
          <div className="space-y-4 motion-opacity-in-0 md:motion-blur-in-md motion-duration-[800ms] motion-delay-300 motion-ease-spring-smooth">
          ...
          <div className="sm:flex hidden flex-row gap-4 motion-opacity-in-0 motion-translate-y-in-100 md:motion-blur-in-md motion-duration-[800ms] motion-delay-700 motion-ease-spring-smooth">
          ...
          <div className="flex sm:hidden flex-col sm:flex-row gap-4 motion-opacity-in-0 motion-translate-y-in-100 md:motion-blur-in-md motion-duration-[800ms] motion-delay-700 motion-ease-spring-smooth">
          ...
          <div className="hidden sm:block space-y-4 motion-opacity-in-0 motion-translate-y-in-100 md:motion-blur-in-md motion-duration-[800ms] motion-delay-[1200ms] motion-ease-spring-smooth">
